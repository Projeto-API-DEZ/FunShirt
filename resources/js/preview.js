function generateTshirtPreview(canvasId, baseImageUrl, designImageUrl, options = {}) {
    ...
    if (!ctx || !baseImageUrl || !designImageUrl) return;
...
document.addEventListener('DOMContentLoaded', initTshirtPreviews);
document.addEventListener('livewire:navigated', initTshirtPreviews);
