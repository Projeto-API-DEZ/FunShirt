<x-layouts::main-content title="Create Account" heading="Join FunShirt" subheading="Register an account to start creating custom t-shirts">
    <div class="max-w-xl mx-auto my-8 p-8 bg-zinc-50 border border-zinc-200 rounded-xl shadow-sm">
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                <div>
                    <label class="block text-sm font-medium text-zinc-700 mb-1">Gender Identification</label>
                    <select name="gender" class="w-full bg-white border border-zinc-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-indigo-500">
